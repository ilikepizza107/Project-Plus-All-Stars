...
copy "../Build/AllStar+/RSBE01.txt" "../Build/AllStar+/NETPLAY.txt" -Force -erroraction 'silentlycontinue'
copy "../Build/AllStar+/BOOST.txt" "../Build/AllStar+/NETBOOST.txt" -Force -erroraction 'silentlycontinue'
New-Item -ItemType Directory -Force -Path "../Build/AllStar+/Source/Netplay/"
copy "../Build/AllStar+/Source/Project+/StageFiles.asm" "../Build/AllStar+/Source/Netplay/Net-StageFiles.asm" -Force -erroraction 'silentlycontinue'
copy "../Build/AllStar+/Source/Project+/Random.asm" "../Build/AllStar+/Source/Netplay/Net-Random.asm" -Force -erroraction 'silentlycontinue'
copy "../Build/AllStar+/Source/Project+/MyMusic.asm" "../Build/AllStar+/Source/Netplay/Net-MyMusic.asm" -Force -erroraction 'silentlycontinue'
copy "../NetplayFiles/seal" "../Build/AllStar+/pf/toy/" -Force -Recurse -erroraction 'silentlycontinue'
copy "../NetplayFiles/Netplay" "../Build/AllStar+/Source/" -Force -Recurse -erroraction 'silentlycontinue'
copy "../NetplayFiles/dnet.cmnu" "../Build/AllStar+/pf/menu3/" -Force -erroraction 'silentlycontinue'
del "../Build/AllStar+/pf/sound/netplaylist" -Confirm:$false -Recurse -erroraction 'silentlycontinue'
Copy-Item "../Build/AllStar+/pf/sound/tracklist" -Destination "../Build/AllStar+/pf/sound/netplaylist" -Force -Recurse -erroraction 'silentlycontinue'
Move-Item "../Build/AllStar+/st" -Destination "../stBackup" -Force

#NETPLAY.txt
$netplayPath = "..\Build\AllStar+\NETPLAY.txt"
(Get-Content $netplayPath).replace('Source/AllStar+/MultiGCT.asm', 'Source/Netplay/Net-MultiGCT.asm') | Set-Content $netplayPath
...
#NETBOOST.txt
$netboostPath = "..\Build\AllStar+\NETBOOST.txt"
(Get-Content $netboostPath).replace('Source/AllStar+/StageFiles.asm', 'Source/Netplay/Net-StageFiles.asm') | Set-Content $netboostPath
...
#Net-MultiGCT
(Get-Content "..\Build\AllStar+\Source\Project+\MultiGCT.asm") -replace 'BOOST.GCT', 'NETBOOST.GCT' | Out-File -encoding ASCII "..\Build\AllStar+\Source\Netplay\Net-MultiGCT.asm"

#Net-StageFiles
$stagefilesPath = "..\Build\AllStar+\Source\Netplay\Net-StageFiles.asm"
...
#Net-MyMusic
$mymusicPath = "..\Build\AllStar+\Source\Netplay\Net-MyMusic.asm"
...
#Net-Random
$randomPath = "..\Build\AllStar+\Source\Netplay\Net-Random.asm"
